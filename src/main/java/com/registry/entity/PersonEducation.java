...
public class PersonEducation implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE,generator="general.person_education_id_seq")
    @SequenceGenerator(sequenceName="general.person_education_id_seq",name="general.person_education_id_seq",allocationSize=1)
